...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("requestForm").addEventListener("submit", function (event) {
        ...
        const formData = {
            ...
            reference_by: formElements["reference_by"].value,
        ...
        fetch("https://script.google.com/macros/s/AKfycbzWL_aUH09YV6Vl65QN9KRyLPTC5Z8dMdvEgXg8eiDAw_fn7azEKzyoNB5j1VcXcgpZ/exec")
                ...
                fetch("https://script.google.com/macros/s/AKfycbzWL_aUH09YV6Vl65QN9KRyLPTC5Z8dMdvEgXg8eiDAw_fn7azEKzyoNB5j1VcXcgpZ/exec", {
                    ...
                    popup.innerHTML = `
                        <div style="
                            ...
                            <p>Your Request ID is : Req<strong>${userId}</strong>.</p>
